// -------------------------------------------------------------------------------------------------
// <copyright file="DiagramDynamicColor.cs" company="RHEA System S.A.">
//
...
namespace Kalliope.Diagrams
{
    ...
    [Description("")]
    [Domain(isAbstract: false, general: "DynamicColor")]
    ...
    public class DiagramDynamicColor : DynamicColor
    {
    }
}
