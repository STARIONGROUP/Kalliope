...
namespace Kalliope.Core
{
    ...
    /// <summary>
    /// A reference to the <see cref="ObjectType"/> that establishes the start point object type for a role path.
    /// </summary>
    [Description("A reference to the object type that establishes the start point object type for a role path.")]
    [Domain(isAbstract: false, general: "ModelThing")]
    [Container(typeName: "RolePath", propertyName: "RootObjectType")]
    public class RootObjectType : ModelThing
    {
