...
While you're working away in your branch it's quite possible that your upstream development (most likely the canonical Kalliope version) may be updated. If this happens you should:
...
- Use `this` when accessing instance members, e.g. `this.Name = "Kalliope";`.
