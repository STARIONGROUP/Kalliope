// -------------------------------------------------------------------------------------------------
// <copyright file="HierarchyExtensions.cs" company="Starion Group S.A.">
//
...
namespace Kalliope.Dal
{
    ...
    /// <summary>
    /// A static class that provides extension methods for the <see cref="Hierarchy"/> class
    /// </summary>
    public static class HierarchyExtensions
    {
        /// <summary>
        /// Updates the value properties of the <see cref="Hierarchy"/> by setting the value equal to that of the dto
        /// Removes deleted objects from the reference properties and returns the unique identifiers
        /// of the objects that have been removed from <see cref="AggregationKind.Composite"/> properties
        /// </summary>
        /// <param name="poco">
        /// The <see cref="Hierarchy"/> that is to be updated
        /// </param>
        /// <param name="dto">
        /// The DTO that is used to update the <see cref="Hierarchy"/> with
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static IEnumerable<string> UpdateValueAndRemoveDeletedReferenceProperties(this Kalliope.Absorption.Hierarchy poco, Kalliope.DTO.Hierarchy dto)
        {
            if (poco == null)
            {
            ...
            poco.DataValueName = dto.DataValueName;
            ...
            poco.ReferenceTypeSuffix = dto.ReferenceTypeSuffix;

            poco.RootElementName = dto.RootElementName;

            poco.SchemaFileTag = dto.SchemaFileTag;

            poco.XmlNamespace = dto.XmlNamespace;

            poco.XmlPrefix = dto.XmlPrefix;

            return identifiersOfObjectsToDelete;
        }

        /// <summary>
        /// Updates the Reference properties of the <see cref="Hierarchy"/> using the data (identifiers) encapsulated in the DTO
        ...
        public static void UpdateReferenceProperties(this Kalliope.Absorption.Hierarchy poco, Kalliope.DTO.Hierarchy dto, ConcurrentDictionary<string, Lazy<Kalliope.Core.ModelThing>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
