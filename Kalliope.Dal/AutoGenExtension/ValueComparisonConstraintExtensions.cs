// -------------------------------------------------------------------------------------------------
// <copyright file="ValueComparisonConstraintExtensions.cs" company="Starion Group S.A.">
//
...
namespace Kalliope.Dal
{
    ...
    /// <summary>
    /// A static class that provides extension methods for the <see cref="ValueComparisonConstraint"/> class
    /// </summary>
    public static class ValueComparisonConstraintExtensions
    {
        /// <summary>
        /// Updates the value properties of the <see cref="ValueComparisonConstraint"/> by setting the value equal to that of the dto
        /// Removes deleted objects from the reference properties and returns the unique identifiers
        /// of the objects that have been removed from <see cref="AggregationKind.Composite"/> properties
        /// </summary>
        /// <param name="poco">
        /// The <see cref="ValueComparisonConstraint"/> that is to be updated
        /// </param>
        /// <param name="dto">
        /// The DTO that is used to update the <see cref="ValueComparisonConstraint"/> with
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static IEnumerable<string> UpdateValueAndRemoveDeletedReferenceProperties(this Kalliope.Core.ValueComparisonConstraint poco, Kalliope.DTO.ValueComparisonConstraint dto)
        {
            if (poco == null)
            {
            ...
            if (poco.OperatorNotSpecifiedError != null && poco.OperatorNotSpecifiedError.Id != dto.OperatorNotSpecifiedError)
            {
                identifiersOfObjectsToDelete.Add(poco.OperatorNotSpecifiedError.Id);
                poco.OperatorNotSpecifiedError = null;
            }
            ...
            {
                identifiersOfObjectsToDelete.Add(poco.RolesNotComparableError.Id);
                poco.RolesNotComparableError = null;
            }
        ...
        /// <summary>
        /// Updates the Reference properties of the <see cref="ValueComparisonConstraint"/> using the data (identifiers) encapsulated in the DTO
        ...
        public static void UpdateReferenceProperties(this Kalliope.Core.ValueComparisonConstraint poco, Kalliope.DTO.ValueComparisonConstraint dto, ConcurrentDictionary<string, Lazy<Kalliope.Core.ModelThing>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
            ...
            if (poco.OperatorNotSpecifiedError == null && !string.IsNullOrEmpty(dto.OperatorNotSpecifiedError) && cache.TryGetValue(dto.OperatorNotSpecifiedError, out lazyPoco))
            {
                poco.OperatorNotSpecifiedError = (ValueComparisonConstraintOperatorNotSpecifiedError)lazyPoco.Value;
            }
            ...
            if (poco.RolesNotComparableError == null && !string.IsNullOrEmpty(dto.RolesNotComparableError) && cache.TryGetValue(dto.RolesNotComparableError, out lazyPoco))
            {
                poco.RolesNotComparableError = (ValueComparisonRolesNotComparableError)lazyPoco.Value;
            }
