// -------------------------------------------------------------------------------------------------
// <copyright file="SinglePrecisionFloatingPointNumericDataTypeExtensions.cs" company="Starion Group S.A.">
//
...
namespace Kalliope.Dal
{
    ...
    /// <summary>
    /// A static class that provides extension methods for the <see cref="SinglePrecisionFloatingPointNumericDataType"/> class
    /// </summary>
    public static class SinglePrecisionFloatingPointNumericDataTypeExtensions
    {
        /// <summary>
        /// Updates the value properties of the <see cref="SinglePrecisionFloatingPointNumericDataType"/> by setting the value equal to that of the dto
        /// Removes deleted objects from the reference properties and returns the unique identifiers
        /// of the objects that have been removed from <see cref="AggregationKind.Composite"/> properties
        /// </summary>
        /// <param name="poco">
        /// The <see cref="SinglePrecisionFloatingPointNumericDataType"/> that is to be updated
        /// </param>
        /// <param name="dto">
        /// The DTO that is used to update the <see cref="SinglePrecisionFloatingPointNumericDataType"/> with
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static IEnumerable<string> UpdateValueAndRemoveDeletedReferenceProperties(this Kalliope.Core.SinglePrecisionFloatingPointNumericDataType poco, Kalliope.DTO.SinglePrecisionFloatingPointNumericDataType dto)
        {
            if (poco == null)
            {
        ...
        /// <summary>
        /// Updates the Reference properties of the <see cref="SinglePrecisionFloatingPointNumericDataType"/> using the data (identifiers) encapsulated in the DTO
        ...
        public static void UpdateReferenceProperties(this Kalliope.Core.SinglePrecisionFloatingPointNumericDataType poco, Kalliope.DTO.SinglePrecisionFloatingPointNumericDataType dto, ConcurrentDictionary<string, Lazy<Kalliope.Core.ModelThing>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
