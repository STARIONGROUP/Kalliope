// -------------------------------------------------------------------------------------------------
// <copyright file="FactTypeDerivationRuleExtensions.cs" company="Starion Group S.A.">
//
...
namespace Kalliope.Dal
{
    ...
    /// </summary>
    public static class FactTypeDerivationRuleExtensions
    {
        /// <summary>
        /// Updates the value properties of the <see cref="FactTypeDerivationRule"/> by setting the value equal to that of the dto
        ...
        /// </exception>
        public static IEnumerable<string> UpdateValueAndRemoveDeletedReferenceProperties(this Kalliope.Core.FactTypeDerivationRule poco, Kalliope.DTO.FactTypeDerivationRule dto)
        {
            if (poco == null)
            {
            ...
            if (poco.FactTypeDerivationPath != null && poco.FactTypeDerivationPath.Id != dto.FactTypeDerivationPath)
            {
                identifiersOfObjectsToDelete.Add(poco.FactTypeDerivationPath.Id);
                poco.FactTypeDerivationPath = null;
            }
        ...
        public static void UpdateReferenceProperties(this Kalliope.Core.FactTypeDerivationRule poco, Kalliope.DTO.FactTypeDerivationRule dto, ConcurrentDictionary<string, Lazy<Kalliope.Core.ModelThing>> cache)
        {
            ...
            if (poco.FactTypeDerivationPath == null && !string.IsNullOrEmpty(dto.FactTypeDerivationPath) && cache.TryGetValue(dto.FactTypeDerivationPath, out lazyPoco))
            {
                poco.FactTypeDerivationPath = (FactTypeDerivationPath)lazyPoco.Value;
            }
        }
    }
}
