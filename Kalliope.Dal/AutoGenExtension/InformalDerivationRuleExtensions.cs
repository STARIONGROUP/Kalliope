// -------------------------------------------------------------------------------------------------
// <copyright file="InformalDerivationRuleExtensions.cs" company="Starion Group S.A.">
//
...
namespace Kalliope.Dal
{
    ...
    /// </summary>
    public static class InformalDerivationRuleExtensions
    {
        /// <summary>
        /// Updates the value properties of the <see cref="InformalDerivationRule"/> by setting the value equal to that of the dto
        ...
        /// </exception>
        public static IEnumerable<string> UpdateValueAndRemoveDeletedReferenceProperties(this Kalliope.Core.InformalDerivationRule poco, Kalliope.DTO.InformalDerivationRule dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Kalliope.Core.InformalDerivationRule poco, Kalliope.DTO.InformalDerivationRule dto, ConcurrentDictionary<string, Lazy<Kalliope.Core.ModelThing>> cache)
        {
            ...
            if (poco.DerivationNote == null && !string.IsNullOrEmpty(dto.DerivationNote) && cache.TryGetValue(dto.DerivationNote, out lazyPoco))
            {
