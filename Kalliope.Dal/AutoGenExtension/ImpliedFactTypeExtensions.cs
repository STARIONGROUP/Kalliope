// -------------------------------------------------------------------------------------------------
// <copyright file="ImpliedFactTypeExtensions.cs" company="RHEA System S.A.">
//
...
namespace Kalliope.Dal
{
    ...
    public static class ImpliedFactTypeExtensions
    {
        ...
        public static void UpdateReferenceProperties(this Kalliope.Core.ImpliedFactType poco, Kalliope.DTO.ImpliedFactType dto, ConcurrentDictionary<string, Lazy<Kalliope.Core.ModelThing>> cache)
        {
            ...
            if (poco.ImpliedByObjectification == null && !string.IsNullOrEmpty(dto.ImpliedByObjectification))
            {
                if (cache.TryGetValue(dto.ImpliedByObjectification, out lazyPoco))
                {
