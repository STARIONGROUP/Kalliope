// -------------------------------------------------------------------------------------------------
// <copyright file="ImpliedFactTypeExtensions.cs" company="Starion Group S.A.">
//
...
namespace Kalliope.Dal
{
    ...
    /// <summary>
    /// A static class that provides extension methods for the <see cref="ImpliedFactType"/> class
    /// </summary>
    public static class ImpliedFactTypeExtensions
    {
        /// <summary>
        /// Updates the value properties of the <see cref="ImpliedFactType"/> by setting the value equal to that of the dto
        /// Removes deleted objects from the reference properties and returns the unique identifiers
        /// of the objects that have been removed from <see cref="AggregationKind.Composite"/> properties
        /// </summary>
        /// <param name="poco">
        /// The <see cref="ImpliedFactType"/> that is to be updated
        /// </param>
        /// <param name="dto">
        /// The DTO that is used to update the <see cref="ImpliedFactType"/> with
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static IEnumerable<string> UpdateValueAndRemoveDeletedReferenceProperties(this Kalliope.Core.ImpliedFactType poco, Kalliope.DTO.ImpliedFactType dto)
        {
            if (poco == null)
            {
            ...
            if (poco.ImpliedByObjectification != null && poco.ImpliedByObjectification.Id != dto.ImpliedByObjectification)
            {
                poco.ImpliedByObjectification = null;
            }
        ...
        /// <summary>
        /// Updates the Reference properties of the <see cref="ImpliedFactType"/> using the data (identifiers) encapsulated in the DTO
        ...
        public static void UpdateReferenceProperties(this Kalliope.Core.ImpliedFactType poco, Kalliope.DTO.ImpliedFactType dto, ConcurrentDictionary<string, Lazy<Kalliope.Core.ModelThing>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
            ...
            if (poco.ImpliedByObjectification == null && !string.IsNullOrEmpty(dto.ImpliedByObjectification) && cache.TryGetValue(dto.ImpliedByObjectification, out lazyPoco))
            {
                poco.ImpliedByObjectification = (Objectification)lazyPoco.Value;
            }
