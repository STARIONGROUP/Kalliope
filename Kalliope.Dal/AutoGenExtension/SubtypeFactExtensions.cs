// -------------------------------------------------------------------------------------------------
// <copyright file="SubtypeFactExtensions.cs" company="Starion Group S.A.">
//
...
namespace Kalliope.Dal
{
    ...
    /// </summary>
    public static class SubtypeFactExtensions
    {
        /// <summary>
        /// Updates the value properties of the <see cref="SubtypeFact"/> by setting the value equal to that of the dto
        ...
        /// </exception>
        public static IEnumerable<string> UpdateValueAndRemoveDeletedReferenceProperties(this Kalliope.Core.SubtypeFact poco, Kalliope.DTO.SubtypeFact dto)
        {
            if (poco == null)
            {
