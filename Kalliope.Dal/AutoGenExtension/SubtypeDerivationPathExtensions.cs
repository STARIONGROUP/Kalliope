// -------------------------------------------------------------------------------------------------
// <copyright file="SubtypeDerivationPathExtensions.cs" company="RHEA System S.A.">
//
...
namespace Kalliope.Dal
{
    ...
    /// <summary>
    /// A static class that provides extension methods for the <see cref="SubtypeDerivationPath"/> class
    /// </summary>
    public static class SubtypeDerivationPathExtensions
    {
        /// <summary>
        /// Updates the value properties of the <see cref="SubtypeDerivationPath"/> by setting the value equal to that of the dto
        /// Removes deleted objects from the reference properties and returns the unique identifiers
        /// of the objects that have been removed from <see cref="AggregationKind.Composite"/> properties
        /// </summary>
        /// <param name="poco">
        /// The <see cref="SubtypeDerivationPath"/> that is to be updated
        /// </param>
        /// <param name="dto">
        /// The DTO that is used to update the <see cref="SubtypeDerivationPath"/> with
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static IEnumerable<string> UpdateValueAndRemoveDeletedReferenceProperties(this Kalliope.Core.SubtypeDerivationPath poco, Kalliope.DTO.SubtypeDerivationPath dto)
        {
            if (poco == null)
            {
            ...
            if (poco.InformalRule != null && poco.InformalRule.Id != dto.InformalRule)
            {
                identifiersOfObjectsToDelete.Add(poco.InformalRule.Id);
                poco.InformalRule = null;
            }
        ...
        /// <summary>
        /// Updates the Reference properties of the <see cref="SubtypeDerivationPath"/> using the data (identifiers) encapsulated in the DTO
        ...
        public static void UpdateReferenceProperties(this Kalliope.Core.SubtypeDerivationPath poco, Kalliope.DTO.SubtypeDerivationPath dto, ConcurrentDictionary<string, Lazy<Kalliope.Core.ModelThing>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
            ...
            if (poco.InformalRule == null && !string.IsNullOrEmpty(dto.InformalRule))
            {
                if (cache.TryGetValue(dto.InformalRule, out lazyPoco))
                {
                    poco.InformalRule = (InformalDerivationRule)lazyPoco.Value;
                }
            }
