// -------------------------------------------------------------------------------------------------
// <copyright file="PathSameFactTypeRoleFollowsJoinErrorExtensions.cs" company="Starion Group S.A.">
//
...
namespace Kalliope.Dal
{
    ...
    /// <summary>
    /// A static class that provides extension methods for the <see cref="PathSameFactTypeRoleFollowsJoinError"/> class
    /// </summary>
    public static class PathSameFactTypeRoleFollowsJoinErrorExtensions
    {
        /// <summary>
        /// Updates the value properties of the <see cref="PathSameFactTypeRoleFollowsJoinError"/> by setting the value equal to that of the dto
        /// Removes deleted objects from the reference properties and returns the unique identifiers
        /// of the objects that have been removed from <see cref="AggregationKind.Composite"/> properties
        /// </summary>
        /// <param name="poco">
        /// The <see cref="PathSameFactTypeRoleFollowsJoinError"/> that is to be updated
        /// </param>
        /// <param name="dto">
        /// The DTO that is used to update the <see cref="PathSameFactTypeRoleFollowsJoinError"/> with
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static IEnumerable<string> UpdateValueAndRemoveDeletedReferenceProperties(this Kalliope.Core.PathSameFactTypeRoleFollowsJoinError poco, Kalliope.DTO.PathSameFactTypeRoleFollowsJoinError dto)
        {
            if (poco == null)
            {
        ...
        /// <summary>
        /// Updates the Reference properties of the <see cref="PathSameFactTypeRoleFollowsJoinError"/> using the data (identifiers) encapsulated in the DTO
        ...
        public static void UpdateReferenceProperties(this Kalliope.Core.PathSameFactTypeRoleFollowsJoinError poco, Kalliope.DTO.PathSameFactTypeRoleFollowsJoinError dto, ConcurrentDictionary<string, Lazy<Kalliope.Core.ModelThing>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
