// -------------------------------------------------------------------------------------------------
// <copyright file="DefinitionExtensions.cs" company="RHEA System S.A.">
//
...
namespace Kalliope.Dal
{
    ...
    public static class DefinitionExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<string> UpdateValueAndRemoveDeletedReferenceProperties(this Kalliope.Core.Definition poco, Kalliope.DTO.Definition dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Kalliope.Core.Definition poco, Kalliope.DTO.Definition dto, ConcurrentDictionary<string, Lazy<Kalliope.Core.ModelThing>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
