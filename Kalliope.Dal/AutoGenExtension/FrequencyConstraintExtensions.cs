// -------------------------------------------------------------------------------------------------
// <copyright file="FrequencyConstraintExtensions.cs" company="RHEA System S.A.">
//
...
namespace Kalliope.Dal
{
    ...
    /// <summary>
    /// A static class that provides extension methods for the <see cref="FrequencyConstraint"/> class
    /// </summary>
    public static class FrequencyConstraintExtensions
    {
        /// <summary>
        /// Updates the value properties of the <see cref="FrequencyConstraint"/> by setting the value equal to that of the dto
        /// Removes deleted objects from the reference properties and returns the unique identifiers
        /// of the objects that have been removed from <see cref="AggregationKind.Composite"/> properties
        /// </summary>
        /// <param name="poco">
        /// The <see cref="FrequencyConstraint"/> that is to be updated
        /// </param>
        /// <param name="dto">
        /// The DTO that is used to update the <see cref="FrequencyConstraint"/> with
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static IEnumerable<string> UpdateValueAndRemoveDeletedReferenceProperties(this Kalliope.Core.FrequencyConstraint poco, Kalliope.DTO.FrequencyConstraint dto)
        {
            if (poco == null)
            {
            ...
            if (poco.FrequencyConstraintExactlyOneError != null && poco.FrequencyConstraintExactlyOneError.Id != dto.FrequencyConstraintExactlyOneError)
            {
                identifiersOfObjectsToDelete.Add(poco.FrequencyConstraintExactlyOneError.Id);
                poco.FrequencyConstraintExactlyOneError = null;
            }

            if (poco.FrequencyConstraintMinMaxError != null && poco.FrequencyConstraintMinMaxError.Id != dto.FrequencyConstraintMinMaxError)
            {
                identifiersOfObjectsToDelete.Add(poco.FrequencyConstraintMinMaxError.Id);
                poco.FrequencyConstraintMinMaxError = null;
            }

            if (poco.FrequencyConstraintNonRestrictiveRangeError != null && poco.FrequencyConstraintNonRestrictiveRangeError.Id != dto.FrequencyConstraintNonRestrictiveRangeError)
            {
                identifiersOfObjectsToDelete.Add(poco.FrequencyConstraintNonRestrictiveRangeError.Id);
                poco.FrequencyConstraintNonRestrictiveRangeError = null;
            }

            if (poco.FrequencyConstraintViolatedByUniquenessConstraintError != null && poco.FrequencyConstraintViolatedByUniquenessConstraintError.Id != dto.FrequencyConstraintViolatedByUniquenessConstraintError)
            {
                identifiersOfObjectsToDelete.Add(poco.FrequencyConstraintViolatedByUniquenessConstraintError.Id);
                poco.FrequencyConstraintViolatedByUniquenessConstraintError = null;
            }
            ...
            poco.MaxFrequency = dto.MaxFrequency;

            poco.MinFrequency = dto.MinFrequency;
        ...
        /// <summary>
        /// Updates the Reference properties of the <see cref="FrequencyConstraint"/> using the data (identifiers) encapsulated in the DTO
        ...
        public static void UpdateReferenceProperties(this Kalliope.Core.FrequencyConstraint poco, Kalliope.DTO.FrequencyConstraint dto, ConcurrentDictionary<string, Lazy<Kalliope.Core.ModelThing>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
            ...
            if (poco.FrequencyConstraintExactlyOneError == null)
            {
            ...
            if (poco.FrequencyConstraintMinMaxError == null)
            {
            ...
            if (poco.FrequencyConstraintNonRestrictiveRangeError == null)
            {
            ...
            if (poco.FrequencyConstraintViolatedByUniquenessConstraintError == null)
            {
