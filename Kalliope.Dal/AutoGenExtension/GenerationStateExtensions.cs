// -------------------------------------------------------------------------------------------------
// <copyright file="GenerationStateExtensions.cs" company="Starion Group S.A.">
//
...
namespace Kalliope.Dal
{
    ...
    {
        /// <summary>
        /// Updates the value properties of the <see cref="GenerationState"/> by setting the value equal to that of the dto
        ...
        /// </exception>
        public static IEnumerable<string> UpdateValueAndRemoveDeletedReferenceProperties(this Kalliope.Core.GenerationState poco, Kalliope.DTO.GenerationState dto)
        {
            if (poco == null)
            {
