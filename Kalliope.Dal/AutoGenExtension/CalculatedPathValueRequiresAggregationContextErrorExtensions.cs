// -------------------------------------------------------------------------------------------------
// <copyright file="CalculatedPathValueRequiresAggregationContextErrorExtensions.cs" company="Starion Group S.A.">
//
...
namespace Kalliope.Dal
{
    ...
    /// <summary>
    /// A static class that provides extension methods for the <see cref="CalculatedPathValueRequiresAggregationContextError"/> class
    /// </summary>
    public static class CalculatedPathValueRequiresAggregationContextErrorExtensions
    {
        /// <summary>
        /// Updates the value properties of the <see cref="CalculatedPathValueRequiresAggregationContextError"/> by setting the value equal to that of the dto
        /// Removes deleted objects from the reference properties and returns the unique identifiers
        /// of the objects that have been removed from <see cref="AggregationKind.Composite"/> properties
        /// </summary>
        /// <param name="poco">
        /// The <see cref="CalculatedPathValueRequiresAggregationContextError"/> that is to be updated
        /// </param>
        /// <param name="dto">
        /// The DTO that is used to update the <see cref="CalculatedPathValueRequiresAggregationContextError"/> with
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static IEnumerable<string> UpdateValueAndRemoveDeletedReferenceProperties(this Kalliope.Core.CalculatedPathValueRequiresAggregationContextError poco, Kalliope.DTO.CalculatedPathValueRequiresAggregationContextError dto)
        {
            if (poco == null)
            {
        ...
        /// <summary>
        /// Updates the Reference properties of the <see cref="CalculatedPathValueRequiresAggregationContextError"/> using the data (identifiers) encapsulated in the DTO
        ...
        public static void UpdateReferenceProperties(this Kalliope.Core.CalculatedPathValueRequiresAggregationContextError poco, Kalliope.DTO.CalculatedPathValueRequiresAggregationContextError dto, ConcurrentDictionary<string, Lazy<Kalliope.Core.ModelThing>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
