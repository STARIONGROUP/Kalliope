// -------------------------------------------------------------------------------------------------
// <copyright file="UniquenessConstraintExtensions.cs" company="Starion Group S.A.">
//
...
namespace Kalliope.Dal
{
    ...
    public static class UniquenessConstraintExtensions
    {
        ...
        public static IEnumerable<string> UpdateValueAndRemoveDeletedReferenceProperties(this Kalliope.Core.UniquenessConstraint poco, Kalliope.DTO.UniquenessConstraint dto)
        {
            ...
            if (poco.PreferredIdentifierFor != null && poco.PreferredIdentifierFor.Id != dto.PreferredIdentifierFor)
            {
                poco.PreferredIdentifierFor = null;
            }
        ...
        public static void UpdateReferenceProperties(this Kalliope.Core.UniquenessConstraint poco, Kalliope.DTO.UniquenessConstraint dto, ConcurrentDictionary<string, Lazy<Kalliope.Core.ModelThing>> cache)
        {
            ...
            if (poco.NMinusOneError == null && !string.IsNullOrEmpty(dto.NMinusOneError) && cache.TryGetValue(dto.NMinusOneError, out lazyPoco))
            {
            ...
            if (poco.PreferredIdentifierFor == null && !string.IsNullOrEmpty(dto.PreferredIdentifierFor) && cache.TryGetValue(dto.PreferredIdentifierFor, out lazyPoco))
            {
                poco.PreferredIdentifierFor = (ObjectType)lazyPoco.Value;
            }
