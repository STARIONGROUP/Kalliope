// -------------------------------------------------------------------------------------------------
// <copyright file="PathObjectUnifierExtensions.cs" company="Starion Group S.A.">
//
...
namespace Kalliope.Dal
{
    ...
    /// <summary>
    /// A static class that provides extension methods for the <see cref="PathObjectUnifier"/> class
    /// </summary>
    public static class PathObjectUnifierExtensions
    {
        /// <summary>
        /// Updates the value properties of the <see cref="PathObjectUnifier"/> by setting the value equal to that of the dto
        /// Removes deleted objects from the reference properties and returns the unique identifiers
        /// of the objects that have been removed from <see cref="AggregationKind.Composite"/> properties
        /// </summary>
        /// <param name="poco">
        /// The <see cref="PathObjectUnifier"/> that is to be updated
        /// </param>
        /// <param name="dto">
        /// The DTO that is used to update the <see cref="PathObjectUnifier"/> with
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static IEnumerable<string> UpdateValueAndRemoveDeletedReferenceProperties(this Kalliope.Core.PathObjectUnifier poco, Kalliope.DTO.PathObjectUnifier dto)
        {
            if (poco == null)
            {
            ...
            if (poco.CompatibilityError != null && poco.CompatibilityError.Id != dto.CompatibilityError)
            {
                identifiersOfObjectsToDelete.Add(poco.CompatibilityError.Id);
                poco.CompatibilityError = null;
            }
        ...
        /// <summary>
        /// Updates the Reference properties of the <see cref="PathObjectUnifier"/> using the data (identifiers) encapsulated in the DTO
        ...
        public static void UpdateReferenceProperties(this Kalliope.Core.PathObjectUnifier poco, Kalliope.DTO.PathObjectUnifier dto, ConcurrentDictionary<string, Lazy<Kalliope.Core.ModelThing>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
            ...
            if (poco.CompatibilityError == null && !string.IsNullOrEmpty(dto.CompatibilityError) && cache.TryGetValue(dto.CompatibilityError, out lazyPoco))
            {
                poco.CompatibilityError = (PathObjectUnifierRequiresCompatibleObjectTypesError)lazyPoco.Value;
            }
