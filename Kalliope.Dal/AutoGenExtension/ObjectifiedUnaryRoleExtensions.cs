// -------------------------------------------------------------------------------------------------
// <copyright file="ObjectifiedUnaryRoleExtensions.cs" company="Starion Group S.A.">
//
...
namespace Kalliope.Dal
{
    ...
    public static class ObjectifiedUnaryRoleExtensions
    {
        ...
        /// <summary>
        /// Updates the Reference properties of the <see cref="ObjectifiedUnaryRole"/> using the data (identifiers) encapsulated in the DTO
        ...
        public static void UpdateReferenceProperties(this Kalliope.Core.ObjectifiedUnaryRole poco, Kalliope.DTO.ObjectifiedUnaryRole dto, ConcurrentDictionary<string, Lazy<Kalliope.Core.ModelThing>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
