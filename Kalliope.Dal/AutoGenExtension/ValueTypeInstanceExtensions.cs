// -------------------------------------------------------------------------------------------------
// <copyright file="ValueTypeInstanceExtensions.cs" company="Starion Group S.A.">
//
...
namespace Kalliope.Dal
{
    ...
    public static class ValueTypeInstanceExtensions
    {
        ...
        /// <summary>
        /// Updates the Reference properties of the <see cref="ValueTypeInstance"/> using the data (identifiers) encapsulated in the DTO
        ...
        public static void UpdateReferenceProperties(this Kalliope.Core.ValueTypeInstance poco, Kalliope.DTO.ValueTypeInstance dto, ConcurrentDictionary<string, Lazy<Kalliope.Core.ModelThing>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
