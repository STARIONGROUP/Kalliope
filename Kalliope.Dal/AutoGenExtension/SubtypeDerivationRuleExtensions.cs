// -------------------------------------------------------------------------------------------------
// <copyright file="SubtypeDerivationRuleExtensions.cs" company="Starion Group S.A.">
//
...
namespace Kalliope.Dal
{
    ...
    public static class SubtypeDerivationRuleExtensions
    {
        ...
        /// <summary>
        /// Updates the Reference properties of the <see cref="SubtypeDerivationRule"/> using the data (identifiers) encapsulated in the DTO
        ...
        public static void UpdateReferenceProperties(this Kalliope.Core.SubtypeDerivationRule poco, Kalliope.DTO.SubtypeDerivationRule dto, ConcurrentDictionary<string, Lazy<Kalliope.Core.ModelThing>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
