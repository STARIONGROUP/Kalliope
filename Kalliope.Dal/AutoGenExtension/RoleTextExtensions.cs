// -------------------------------------------------------------------------------------------------
// <copyright file="RoleTextExtensions.cs" company="Starion Group S.A.">
//
...
namespace Kalliope.Dal
{
    ...
    /// <summary>
    /// A static class that provides extension methods for the <see cref="RoleText"/> class
    /// </summary>
    public static class RoleTextExtensions
    {
        /// <summary>
        /// Updates the value properties of the <see cref="RoleText"/> by setting the value equal to that of the dto
        /// Removes deleted objects from the reference properties and returns the unique identifiers
        /// of the objects that have been removed from <see cref="AggregationKind.Composite"/> properties
        /// </summary>
        /// <param name="poco">
        /// The <see cref="RoleText"/> that is to be updated
        /// </param>
        /// <param name="dto">
        /// The DTO that is used to update the <see cref="RoleText"/> with
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Updates the Reference properties of the <see cref="RoleText"/> using the data (identifiers) encapsulated in the DTO
