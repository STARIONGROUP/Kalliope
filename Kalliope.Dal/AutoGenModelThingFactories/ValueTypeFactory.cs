// -------------------------------------------------------------------------------------------------
// <copyright file="ValueTypeFactory.cs" company="RHEA System S.A.">
//
...
namespace Kalliope.Dal
{
    ...
    /// <summary>
    /// The purpose of the <see cref="ValueTypeFactory"/> is to create a new instance of a
    /// <see cref="Kalliope.Core.ValueType"/> based on a <see cref="Kalliope.DTO.ValueType"/>
    /// </summary>
    public class ValueTypeFactory
    {
        /// <summary>
        /// Creates an instance of the <see cref="ValueType"/> and sets the value properties
        /// based on the DTO
        /// </summary>
        /// <param name="dto">
        /// The instance of the <see cref="Kalliope.DTO.ValueType"/>
        /// </param>
        /// <returns>
        /// an instance of <see cref="Kalliope.Core.ValueType"/>
        /// </returns>
        /// <exception cref="ArgumentNullException">
        /// thrown when <paramref name="dto"/> is null
        /// </exception>
        public Kalliope.Core.ValueType Create(Kalliope.DTO.ValueType dto)
        {
            if (dto == null)
            {
            ...
            var valueType = new Kalliope.Core.ValueType()
            {
