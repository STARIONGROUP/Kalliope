// -------------------------------------------------------------------------------------------------
// <copyright file="JoinedConstraintRoleProjectionCompatibilityError.cs" company="Starion Group S.A.">
//
...
namespace Kalliope.DTO
{
    ...
    /// </remarks>
    public partial class JoinedConstraintRoleProjectionCompatibilityError : ModelError
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JoinedConstraintRoleProjectionCompatibilityError"/> class.
        /// </summary>
        public JoinedConstraintRoleProjectionCompatibilityError()
        {
        }
