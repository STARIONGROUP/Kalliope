// -------------------------------------------------------------------------------------------------
// <copyright file="ModelNoteShape.cs" company="Starion Group S.A.">
//
...
namespace Kalliope.DTO
{
    ...
    public partial class ModelNoteShape : FloatingTextShape
    {
        ...
        [Property(name: "Subject", aggregation: AggregationKind.None, multiplicity: "1..1", typeKind: TypeKind.Object, defaultValue: "", typeName: "ModelNote", allowOverride: false, isOverride: false, isDerived: false)]
