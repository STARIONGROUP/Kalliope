// -------------------------------------------------------------------------------------------------
// <copyright file="PathConstant.cs" company="Starion Group S.A.">
//
...
namespace Kalliope.DTO
{
    ...
    public partial class PathConstant : OrmModelElement
    {
        ...
        [Property(name: "LexicalValue", aggregation: AggregationKind.None, multiplicity: "1..1", typeKind: TypeKind.String, defaultValue: "", typeName: "", allowOverride: false, isOverride: false, isDerived: false)]
