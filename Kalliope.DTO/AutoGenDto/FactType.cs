// -------------------------------------------------------------------------------------------------
// <copyright file="FactType.cs" company="Starion Group S.A.">
//
...
namespace Kalliope.DTO
{
    ...
    public partial class FactType : OrmModelElement
    {
        ...
        /// </summary>
        [Description("")]
        [Property(name: "DerivationExpression", aggregation: AggregationKind.Composite, multiplicity: "0..1", typeKind: TypeKind.Object, defaultValue: "", typeName: "FactTypeDerivationExpression", allowOverride: false, isOverride: false, isDerived: false)]
        ...
        /// </summary>
        [Description("")]
        [Property(name: "FactTypeInstances", aggregation: AggregationKind.Composite, multiplicity: "0..*", typeKind: TypeKind.Object, defaultValue: "", typeName: "FactTypeInstance", allowOverride: false, isOverride: false, isDerived: false)]
        ...
        /// </summary>
        [Description("")]
        [Property(name: "ImpliedInternalUniquenessConstraintError", aggregation: AggregationKind.Composite, multiplicity: "0..1", typeKind: TypeKind.Object, defaultValue: "", typeName: "ImpliedInternalUniquenessConstraintError", allowOverride: false, isOverride: false, isDerived: false)]
        ...
        [Property(name: "InternalConstraints", aggregation: AggregationKind.None, multiplicity: "0..*", typeKind: TypeKind.Object, defaultValue: "", typeName: "SetConstraint", allowOverride: false, isOverride: false, isDerived: false)]
        ...
        /// </summary>
        [Description("")]
        [Property(name: "InternalUniquenessConstraintRequiredError", aggregation: AggregationKind.Composite, multiplicity: "0..1", typeKind: TypeKind.Object, defaultValue: "", typeName: "FactTypeRequiresInternalUniquenessConstraintError", allowOverride: false, isOverride: false, isDerived: false)]
        ...
        /// </summary>
        [Description("")]
        [Property(name: "ReadingOrders", aggregation: AggregationKind.Composite, multiplicity: "0..*", typeKind: TypeKind.Object, defaultValue: "", typeName: "ReadingOrder", allowOverride: false, isOverride: false, isDerived: false)]
        ...
        /// </summary>
        [Description("")]
        [Property(name: "ReadingRequiredError", aggregation: AggregationKind.Composite, multiplicity: "0..1", typeKind: TypeKind.Object, defaultValue: "", typeName: "FactTypeRequiresReadingError", allowOverride: false, isOverride: false, isDerived: false)]
        ...
        /// </summary>
        [Description("")]
        [Property(name: "Roles", aggregation: AggregationKind.Composite, multiplicity: "1..*", typeKind: TypeKind.Object, defaultValue: "", typeName: "RoleBase", allowOverride: false, isOverride: false, isDerived: false)]
