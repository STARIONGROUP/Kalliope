...
namespace Kalliope.DTO
{
    ...
    public partial class FunctionParameter : OrmNamedElement
    {
        ...
        /// </summary>
        [Description("")]
        [Property(name: "BagInput", aggregation: AggregationKind.None, multiplicity: "1..1", typeKind: TypeKind.Boolean, defaultValue: "false", typeName: "", allowOverride: false, isOverride: false, isDerived: false)]
