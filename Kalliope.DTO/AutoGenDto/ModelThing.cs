// -------------------------------------------------------------------------------------------------
// <copyright file="ModelThing.cs" company="Starion Group S.A.">
//
...
namespace Kalliope.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object that represents a ModelThing
    /// </summary>
    /// <remarks>
    /// Abstract super type from which all Kalliope Core classes derive
    /// </remarks>
    public abstract partial class ModelThing
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModelThing"/> class.
        /// </summary>
