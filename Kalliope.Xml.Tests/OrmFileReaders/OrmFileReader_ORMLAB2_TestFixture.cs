// -------------------------------------------------------------------------------------------------
// <copyright file="OrmFileReader_ORMLAB2_TestFixture.cs" company="Starion Group S.A.">
//
...
namespace Kalliope.Xml.Tests.OrmFileReaders
{
    ...
    public class OrmFileReader_ORMLAB2_TestFixture
    {
        ...
        public void Verify_that_the_ORM_File_can_be_read_and_returns_expected_ORMModel()
        {
            ...
            // Objects
            Assert.That(this.ormRoot.Model.ObjectTypes.OfType<Core.EntityType>().Count(), Is.EqualTo(5));
            Assert.That(this.ormRoot.Model.ObjectTypes.OfType<Core.ValueType>().Count(), Is.EqualTo(10));
            ...
            // Facts
            Assert.That(this.ormRoot.Model.FactTypes.Count, Is.EqualTo(16));
            ...
            // Constraints
            Assert.That(this.ormRoot.Model.SetConstraints.OfType<Core.MandatoryConstraint>().Count(), Is.EqualTo(25));
            var mandatoryConstraint = this.ormRoot.Model.SetConstraints.OfType<Core.MandatoryConstraint>().Single(x => x.Id == "_4AF1D6BC-4EFB-4AF9-A1E7-6EBBF9FE8396");
            ...
            Assert.That(this.ormRoot.Model.SetConstraints.OfType<Core.UniquenessConstraint>().Count(), Is.EqualTo(22));
