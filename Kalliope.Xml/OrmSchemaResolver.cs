// -------------------------------------------------------------------------------------------------
// <copyright file="OrmSchemaResolver.cs" company="Starion Group S.A.">
//
...
namespace Kalliope.Xml
{
    ...
    /// <summary>
    /// The purpose of the <see cref="OrmSchemaResolver"/> is to resolve the imported and included
    /// XML namespaces in an <see cref="XmlSchema"/>
    /// </summary>
    public class OrmSchemaResolver : XmlUrlResolver
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OrmSchemaResolver"/> class.
        /// </summary>
        public OrmSchemaResolver()
        {
