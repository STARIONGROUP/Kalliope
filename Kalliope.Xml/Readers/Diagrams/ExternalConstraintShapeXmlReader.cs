// -------------------------------------------------------------------------------------------------
// <copyright file="ExternalConstraintShapeXmlReader.cs" company="Starion Group S.A.">
//
...
namespace Kalliope.Xml.Readers
{
    ...
    public class ExternalConstraintShapeXmlReader : OrmBaseShapeXmlReader
    {
        ...
        /// </summary>
        /// <param name="externalConstraintShape">
        /// The subject <see cref="ExternalConstraintShape"/> that is to be deserialized
        /// </param>
        /// <param name="reader">
