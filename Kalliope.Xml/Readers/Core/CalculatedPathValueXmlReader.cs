// -------------------------------------------------------------------------------------------------
// <copyright file="CalculatedPathValueXmlReader.cs" company="Starion Group S.A.">
//
...
namespace Kalliope.Xml.Readers
{
    ...
    public class CalculatedPathValueXmlReader : OrmModelElementXmlReader
    {
        ...
        /// </summary>
        /// <param name="calculatedPathValue">
        /// The subject <see cref="CalculatedPathValue"/> that is to be deserialized
        /// </param>
        /// <param name="reader">
