// -------------------------------------------------------------------------------------------------
// <copyright file="FactTypeDerivationPathXmlReader.cs" company="Starion Group S.A.">
//
...
namespace Kalliope.Xml.Readers
{
    ...
    /// <summary>
    /// The purpose of the <see cref="FactTypeDerivationPathXmlReader"/> is to deserialize a <see cref="FactTypeDerivationPath"/>
    /// from an .orm XML file
    /// </summary>
    public class FactTypeDerivationPathXmlReader : RolePathOwnerXmlReader
    {
        /// <summary>
        /// Reads the properties of the provided <see cref="FactType"/> from the <see cref="XmlReader"/>
        /// </summary>
        /// <param name="factTypeDerivationPath">
        /// The subject <see cref="FactTypeDerivationPath"/> that is to be deserialized
        /// </param>
        /// <param name="reader">
        ...
        /// </param>
        public void ReadXml(FactTypeDerivationPath factTypeDerivationPath, XmlReader reader, List<ModelThing> modelThings)
        {
