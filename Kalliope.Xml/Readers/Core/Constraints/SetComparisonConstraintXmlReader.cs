// -------------------------------------------------------------------------------------------------
// <copyright file="SetComparisonConstraintXmlReader.cs" company="Starion Group S.A.">
//
...
namespace Kalliope.Xml.Readers
{
    ...
    public abstract class SetComparisonConstraintXmlReader : OrmNamedElementXmlReader
    {
        ...
        /// </summary>
        /// <param name="setComparisonConstraint">
        /// The subject <see cref="SetComparisonConstraint"/> that is to be deserialized
        /// </param>
        /// <param name="reader">
