// -------------------------------------------------------------------------------------------------
// <copyright file="QueryParameterXmlReader.cs" company="Starion Group S.A.">
//
...
namespace Kalliope.Xml.Readers
{
    ...
    public class QueryParameterXmlReader : OrmModelElementXmlReader
    {
        ...
        /// The subject <see cref="QueryParameter"/> that is to be deserialized
        /// </param>
        /// <param name="reader">
        ...
        /// </param>
        public void ReadXml(QueryParameter queryParameter, XmlReader reader, List<ModelThing> modelThings)
        {
            base.ReadXml(queryParameter, reader, modelThings);
        }
    }
}
