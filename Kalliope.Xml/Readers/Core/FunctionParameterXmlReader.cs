// -------------------------------------------------------------------------------------------------
// <copyright file="FunctionParameterXmlReader.cs" company="Starion Group S.A.">
//
...
namespace Kalliope.Xml.Readers
{
    ...
    public class FunctionParameterXmlReader : OrmNamedElementXmlReader
    {
        ...
        /// The subject <see cref="FunctionParameter"/> that is to be deserialized
        /// </param>
        /// <param name="reader">
        ...
        /// </param>
        public void ReadXml(FunctionParameter functionParameter, XmlReader reader, List<ModelThing> modelThings)
        {
            base.ReadXml(functionParameter, reader, modelThings);
        }
    }
}
