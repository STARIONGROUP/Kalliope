// -------------------------------------------------------------------------------------------------
// <copyright file="ModelThingFactoryGenerator.cs" company="Starion Group S.A.">
//
...
namespace Kalliope.Generator.Generators
{
    ...
    /// <summary>
    /// The purpose of the <see cref="ModelThingFactoryGenerator"/> is to generate Kalliope ModelThing Extension class
    /// </summary>
    public class ModelThingFactoryGenerator : Generator
    {
        /// <summary>
        /// name of the DTO Template
        /// </summary>
        private const string ModelThingFactoryTemplate = "modelthingfactory-template";
        ...
        {
            this.LiquidTemplates.Add(ModelThingFactoryTemplate, this.LoadTemplate(ModelThingFactoryTemplate));
        }
        ...
        public override void Generate(DirectoryInfo outputDirectory)
        {
            ...
            var filePath = Path.Combine(outputDirectory.FullName, "ModelThingFactory.cs");
        ...
        /// </summary>
        /// <param name="drops">
        /// The subject <see cref="IEnumerable{TypeDrop}"/>
        /// </param>
        /// <returns>
        ...
        {
            string modelThingFactoryTemplate;
            if (!this.LiquidTemplates.TryGetValue(ModelThingFactoryTemplate, out modelThingFactoryTemplate))
            {
                throw new KeyNotFoundException("Could not load the ModelThing Extensions Template");
            }

            var template = Template.Parse(modelThingFactoryTemplate);
